...
class Compound(BaseModel):
    ...
    open_circuit_voltage = ListType(ModelType(MeltingPoint))
    short_circuit_current_density = ListType(ModelType(MeltingPoint))
    fill_factor = ListType(ModelType(MeltingPoint))
    conversion_efficiency = ListType(ModelType(MeltingPoint))
    band_gap = ListType(ModelType(MeltingPoint))
