...
prefix = Optional(I('a')).hide() + (Optional(lbrct) + W('FF') + Optional(rbrct)| R('%', re.I) | (I('fill') + I('factor')) | R('%', re.I) + R('^pt?\.?$', re.I)).hide() + Optional(lbrct + W('FF') + rbrct) + Optional(W('=') | I('of') | I('was') | I('is') | I('at')).hide() + Optional(I('in') + I('the') + I('range') + Optional(I('of')) | I('about')).hide()
